...
contract ERC20Interface {
    ...
    /**
    * @dev All methods of the basic version of a Standard Token
    */
...
/**
* Implementation of Diagon Token of a Standard Token
*/
contract DiagonToken is ERC20Interface {
    ...
    /**
    * A total token supply of 40 million Diagon Coin created
    */
    constructor () public {
...
/**
* Using the Fiat Contract Library to check current rate of Ethereum
*/
...
/**
* Implementation of Diagon ICO Contract
*/
contract DiagonICO is DiagonToken {
    ...
    /**
    * Diagon Coin price set for $0.2 at ICO/IEO
    */
    ...
    /**
    * Diagon Coin vesting period ends 24th February, 2020
    */
    ...
    /**
    * The ICO/IEO contribution function through the smart contract
    */
    function invest() payable public returns(bool){
        ...
        /**
        * Adding tokens to investors Balance
        */
        balances[msg.sender] += tokens;
        balances[founder] -= tokens;
    
        /**
        * Transfer of funds by Smart Contract to Deposit Address
        */
    ...
    /**
    * The Burn function for Diagon Coin
    */
    ...
    /**
    * Contribution function from external addresses
    */
